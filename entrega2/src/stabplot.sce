...
//F='(eye(A) + h * A) * 0.24 + (1-0.24) * inv(eye(A) - h * A)'; //metodo-0.24
//F='(eye(A) + h * A) * 0.249 + (1-0.249) * inv(eye(A) - h * A)'; //metodo-0.249
//F='(eye(A) + h * A) * 0.25 + (1-0.25) * inv(eye(A) - h * A)'; //metodo-0.25
